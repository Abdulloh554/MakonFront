      ...
      <PageTransition>
        <div className="flex-1 flex items-center justify-center px-4 md:px-8">
          ...
          >
            ...
            <p className="text-sm text-gray-500">{t('login.no_account')}</p>
    ...
    <PageTransition>
      ...
      <div className="flex-1 px-4 md:px-6 lg:px-8 pt-4 pb-24 lg:pb-8">
        <div className="flex items-center justify-between mb-3">
          <h2 className="text-sm font-semibold text-gray-700">{t('profile.listings')}</h2>
          <motion.button
            whileHover={{ scale: 1.02 }}
            whileTap={{ scale: 0.98 }}
        ...
        {myProperties.length === 0 ? (
          <EmptyState
            ...
            action={{ label: t('property_form.submit'), onClick: () => router.push('/add') }}
          />
        ) : (
