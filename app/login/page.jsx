    ...
    return (
      <div className="min-h-screen flex items-center justify-center px-4" style={{ background: '#f8fafc' }}>
        ...
        >
          ...
          <p className="text-sm text-slate-500 mb-1">Elektron pochtangizga kirish havolasi yuborildi.</p>
    ...
    <div className="min-h-screen flex items-center justify-center px-4" style={{ background: '#f8fafc' }}>
      <div className="w-full max-w-sm bg-white rounded-2xl p-6" style={{ boxShadow: '0 4px 24px rgba(15,23,42,0.08)' }}>
        <div className="text-center mb-6">
          ...
          <p className="text-xs text-slate-400 mt-1">Hisobingizga kiring</p>
        </div>
